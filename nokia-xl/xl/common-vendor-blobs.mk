...
PRODUCT_COPY_FILES += vendor/nokia/xl/common/vendor/lib/egl/eglsubAndroid.so:system/vendor/lib/egl/eglsubAndroid.so
PRODUCT_COPY_FILES += vendor/nokia/xl/common/vendor/lib/egl/libEGL_adreno.so:system/vendor/lib/egl/libEGL_adreno.so
PRODUCT_COPY_FILES += vendor/nokia/xl/common/vendor/lib/egl/libGLESv1_CM_adreno.so:system/vendor/lib/egl/libGLESv1_CM_adreno.so
PRODUCT_COPY_FILES += vendor/nokia/xl/common/vendor/lib/egl/libGLESv2_adreno.so:system/vendor/lib/egl/libGLESv2_adreno.so
PRODUCT_COPY_FILES += vendor/nokia/xl/common/vendor/lib/egl/libGLESv2S3D_adreno.so:system/vendor/lib/egl/libGLESv2S3D_adreno.so
PRODUCT_COPY_FILES += vendor/nokia/xl/common/vendor/lib/egl/libq3dtools_adreno.so:system/vendor/lib/egl/libq3dtools_adreno.so
PRODUCT_COPY_FILES += vendor/nokia/xl/common/vendor/lib/libadreno_utils.so:system/vendor/lib/libadreno_utils.so
PRODUCT_COPY_FILES += vendor/nokia/xl/common/vendor/lib/libC2D2.so:system/vendor/lib/libC2D2.so
PRODUCT_COPY_FILES += vendor/nokia/xl/common/vendor/lib/libc2d2_z180.so:system/vendor/lib/libc2d2_z180.so
PRODUCT_COPY_FILES += vendor/nokia/xl/common/vendor/lib/libCB.so:system/vendor/lib/libCB.so
PRODUCT_COPY_FILES += vendor/nokia/xl/common/vendor/lib/libgsl.so:system/vendor/lib/libgsl.so
PRODUCT_COPY_FILES += vendor/nokia/xl/common/vendor/lib/libOpenCL.so:system/vendor/lib/libOpenCL.so
PRODUCT_COPY_FILES += vendor/nokia/xl/common/vendor/lib/libOpenVG.so:system/vendor/lib/libOpenVG.so
PRODUCT_COPY_FILES += vendor/nokia/xl/common/vendor/lib/libsc-a2xx.so:system/vendor/lib/libsc-a2xx.so
